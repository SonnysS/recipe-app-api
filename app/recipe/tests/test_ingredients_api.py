...
class PrivateIngredientApiTests(TestCase):
    ...
    def test_update_ingredient(self):
        """Test update ingredient in database."""
    ...
    def test_delete_ingredient(self):
        """Test deleteing an ingredient in database."""
    ...
    def test_filtered_uniqe_ingredient(self):
        """Tets filtering ingredients returns unique list."""
