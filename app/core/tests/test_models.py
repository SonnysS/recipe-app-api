...
class ModelTests(TestCase):
    ...
    def test_new_user_without_email_raises_error(self):
        """Test that creating a new user without an email raises a ValuError.""" # noqa
    ...
    def test_create_reciepe(self):
        """Test to create a new reciepe in the system."""
        user = get_user_model().objects.create_user(
            'test@example.com',
            'testpass123'
        )
        ...
        recipe = models.Recipe.objects.create(
            ...
            time_minutes=5,
            price=Decimal('5.50'),
            description='Sample recipe description name'
        )
